...
scene1.to('.sec1_tit1', {delay:6000,duration:6000, scale: .8, y: -230},'start3')
scene1.to('.sec1_tit2', {delay:6000,duration:6000, scale: .8, y: -160},'start3')
...
scene1.to('.sec1_tit3 .on_kor', {delay:1000, duration: 0,opacity: 1,})
scene1.to('.sec1_tit3 .on1', {duration:6000, opacity: 1, x:80})
scene1.to('.sec1_tit3 .on0', {delay:6000,duration: 100, opacity: 1, x:20})
...
scene1.to('.sec1_tit3 .on_txt',  {delay:3000, duration: 100, opacity:0, scale:0})
scene1.to('.sec1_tit3 .on_en', {duration:3000, opacity: 1, x:20})
...
scene1.to('.sec1_tit3 .on1',  { duration:6000, x:200},'logo')
...
// 스위치켜기
scene1.add('logo3')
scene1.to('.sec1_tit3 .on_en', {delay:1000,duration:600, opacity:0,  x: 100},'logo3')
scene1.to('.sec1_tit3 .on_kor', {delay:1000,duration:6000, x: 180},'logo3')
scene1.to('.sec1_tit3 .on_kor_txt', {delay:1000,duration:6000, opacity:0,  x: 100},'logo3')
scene1.to('.sec1_tit3 .logo_copy', {delay:1000,duration:6000, opacity:0,  y: 100},'logo3')
...
scene1.to('.sec1_tit3 .on0', {delay:6000,duration:8000,opacity:0 },'movie')
